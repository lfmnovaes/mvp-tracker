...
Step 3 bundles kar-mi's AGPL-3.0-only packages: @kar-mi/spirit-vale-tools-capture 3.0.2 and @kar-mi/spirit-vale-tools-character 0.6.1, with character dependencies @kar-mi/spirit-vale-tools-items and @kar-mi/spirit-vale-tools-skills pinned in bun.lock. Corresponding source is available at https://github.com/kar-mi/spirit-vale-tools/tree/87db1d724d5738ec8b5f3cb258e357e757813264, in packages/capture, packages/character, packages/items and packages/skills. LICENSE.txt contains the applicable AGPL text. Only passive capture, grave/monster/position decoding and local character identity are used; no combat/reward collectors are started. Npcap is a separately installed prerequisite, not redistributed.

The experimental entity adapter uses decodeMonsterSpawn and the capture packet position/health fields. Its ground-plane interpretation follows the overlay minimap's world X/Z usage; it does not claim calibrated game-map coordinates.
