...
The runtime bundles kar-mi's AGPL-3.0-only packages: @kar-mi/spirit-vale-tools-capture 3.0.3 and @kar-mi/spirit-vale-tools-character 0.6.1, with character dependencies @kar-mi/spirit-vale-tools-items 0.1.12 and @kar-mi/spirit-vale-tools-skills 0.2.5 pinned in bun.lock. Corresponding source is available at https://github.com/kar-mi/spirit-vale-tools/tree/6e075bea7e81270b5fca81a49e1e2f5bc6fde10b, in packages/capture, packages/character, packages/items and packages/skills. LICENSE.txt contains the applicable AGPL text. Only passive capture, grave/position decoding and local character identity are used; no combat/reward collectors are started. Npcap is a separately installed prerequisite, not redistributed.
