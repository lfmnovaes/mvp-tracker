...
function App() {
  ...
  useEffect(() => { if (snapshot?.sync?.message.startsWith("Removed")) setMessage(snapshot.sync.message); }, [snapshot?.sync?.message]);
